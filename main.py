...
# one symptoms can appear in multiple categories
...
urinary_symptoms = ["burning_micturition", "yellow_urine", "yellowing_of_eyes", 
                    "foul_smell_of urine", "continuous_feel_of_urine", "bladder_discomfort", "polyuria"]
...
digestive_symptoms = ["pain_during_bowel_movements", "pain_in_anal_region", "bloody_stool",
                      ...
                      "acidity", "ulcers_on_tongue", "vomiting", "spotting_ urination", "loss_of_appetite",
...
skin_symptoms = ["bruising", "brittle_nails", "pus_filled_pimples", "blackheads", "redness_of_eyes",
                 ...
                 "drying_and_tingling_lips", "dischromic _patches", "internal_itching"]
...
class PredictDis(QMainWindow):
    def __init__(self):
        ...
        self.reset_button = QPushButton("Empty the symptom list", self)
